...
namespace Codebot.Storage
{
    ...
    /// <summary>
    /// Represents an Storage Object.
    /// </summary>
    public sealed class ObjectEntry : ListEntry
    {
        /// <summary>
        /// Gets the unique Storage Object key.
        /// </summary>
        public string Key { get; private set; }
        
        /// <summary>
        /// Gets the last modified date of this object, as determined by Storage.
        /// </summary>
        public DateTime LastModified { get; private set; }

        /// <summary>
        /// Gets the ETag of this object, as computed by Storage.
        /// </summary>
        ...
        internal ObjectEntry(XmlReader reader, string searchPrefix, string delimiter)
        {
			...
			if (reader.Name == "Generation")
				reader.ReadElementContentAsString("Generation", "");
			if (reader.Name == "MetaGeneration")
				reader.ReadElementContentAsString("MetaGeneration", "");
			if (reader.Name == "LastModified")
			...
			// this tag may be omitted if you don't have permission to view the owne
			if (reader.Name == "Owner")
				this.Owner = new Identity(reader);
			// this element is meaningles
        ...
        {
            return string.Format("StorageObject \"{0}\"", Name);
        }
    }

    /// <summary>
    /// Represents a common prefix rolled up by a ListObjectsRequest. In a filesystem-like
    /// interpretation of Amazon Storage using a delimiter of "/", you might consider this a "directory".
    /// </summary>
