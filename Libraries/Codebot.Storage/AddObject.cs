...
namespace Codebot.Storage
{
    ...
    /// </summary>
    public class AddObjectRequest : StorageRequest<AddObjectResponse>
    {
        // created on demand to save memory
        NameValueCollection metadata;
        bool contentLengthWasSet;

        public AddObjectRequest(StorageService service, string bucketName, string objectKey)
            : base(service, "PUT", bucketName, objectKey, null)
        {
            this.CannedAcl = CannedAcl.Private;
            // disabled for now - results in flaky behavior (see remarks on StorageRequest.ServicePoint)
        ...
        /// stored by Storage and returned as a standard Expires header when the object is retrieved.
        /// </summary>
        ...
        /// Storage to return along with your object when requested. An example value for this might
        /// be "max-age=3600, must-revalidate".
        /// </summary>
        public string CacheControl { get; set; }

        /// <summary>
        /// Gets or sets the MIME type of this object. It will be stored by Storage and returned as a
        ...
        /// <summary>
        /// Gets or sets presentational information for the object. It will be stored by Storage and
        ...
        /// <summary>
        /// Gets or sets the specified encoding of the object data. It will be stored by Storage 
    ...
    /// <summary>
    /// Represents the response returned by Storage after adding an object with AddObjectRequest.
    /// </summary>
    public sealed class AddObjectResponse : StorageResponse
    {
        /// <summary>
        /// Gets the added object's ETag as calculated by Storage. You can compare this to an ETag you
        /// calculate locally to verify that Storage received the file correctly.
        /// </summary>
