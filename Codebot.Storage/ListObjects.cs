...
namespace Codebot.Storage
{
    ...
    /// <summary>
    /// An Storage request which searches for items in a bucket.
    /// </summary>
    public class ListObjectsRequest : StorageRequest<ListObjectsResponse>
    {
        public string BucketName { get; private set; }
        public ListObjectsArgs Args { get; private set; }

        public ListObjectsRequest(StorageService service, string bucketName, ListObjectsArgs args)
    ...
    /// <summary>
    /// An Storage response describing the requested contents of a bucket.
    /// </summary>
    public class ListObjectsResponse : StorageResponse
    {
        protected override void ProcessResponse()
        {
			// See http://docs.amazonwebservices.com/AmazonStorage/2006-03-01/ListingKeysResponse.html
