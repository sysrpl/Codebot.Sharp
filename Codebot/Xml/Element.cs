...
namespace Codebot.Xml
{
	public class Element : Node
	{
		...
		public Elements Nodes
		{
			...
			{
				if (elements == null)
					elements = new Elements(InternalNode);
				return elements;
			}
		}
		...
		{
			var node = InternalNode.SelectSingleNode(xpath) as XmlAttribute;
		...
		{
			var node = InternalNode.SelectSingleNode(xpath) as XmlElement;
